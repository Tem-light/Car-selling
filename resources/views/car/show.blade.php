    ...
    <main>
        <div class="container">
            <h1 class="car-details-page-title">
                {{ $car->maker?->name ?? 'Unknown Maker' }}
                {{ $car->carModel?->name ?? 'Unknown Model' }}
                - {{ $car->year }}
            </h1>

            <div class="car-details-region">
                {{ $car->city?->name ?? 'Unknown City' }} - {{ $car->published_at }}
            </div>
            ...
            <div class="car-details-content">
                ...
                <div class="car-details card">
                    ...
                    <div class="flex gap-1 my-medium">
                        ...
                        <div>
                            <h3 class="car-details-owner">{{ $car->owner?->name ?? 'Unknown Owner' }}</h3>
                            <div class="text-muted">{{ $car->owner?->cars_count ?? 0 }} cars</div>
                        </div>
                    </div>
